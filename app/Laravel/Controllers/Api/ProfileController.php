...
use App\Laravel\Requests\Api\ProfileEditFieldRequest;
...
class ProfileController extends Controller
{
    ...
    public function update_profile(ProfileRequest $request, $format = '') {
        ...
        $user->password = bcrypt($request->get('password') ?: $user->contact);
    ...
    public function update_field(ProfileEditFieldRequest $request, $format = '') {
