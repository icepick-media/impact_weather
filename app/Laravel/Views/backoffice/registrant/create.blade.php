  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Create Registrant Contact</h3>
        <p class="text-muted mb-0">Add a new registant to your mobile application.</p>
      </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Registrant Contact Details</h4>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('contact_number') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="contact_number" class="form-control" placeholder="contact_number" name="contact_number" value="{{ old('contact_number') }}">
