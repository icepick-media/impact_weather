  ...
  <div class="content-wrapper">
    <div class="content-header1 row">
        <div class="content-header-left col-md-6 col-xs-12">
            <h3 class="content-header-title mb-0">All Registrant</h3>
            {{--<p class="text-muted mb-0">Record data of all registrant in your mobile application.</p>--}}
          <div class="breadcrumb-wrapper col-xs-12 breadcrumb-top-dashboard">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="{{ route('backoffice.index') }}">Home</a></li>
              <li class="breadcrumb-item active">Registant Contact</li>
            </ol>
          </div>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      <thead>
                        <tr>
                          ...
                          <th>Enable weather <BR> station</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $registrant->allow_weather_station }}</td>
                          <td>{{ $registrant->updated_at->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.registrant.destroy', [$registrant->id]) }}" href="#">Delete</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
