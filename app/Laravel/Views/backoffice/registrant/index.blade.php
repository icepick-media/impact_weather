                      ...
                      <td>
                        ...
                        <div class="btn-group dropup">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item btn btn-warning" href="{{ route('backoffice.registrant.edit', [$registrant->id]) }}">Edit</a>
                                <a class="dropdown-item btn-delete btn btn-danger" data-url="{{ route('backoffice.registrant.destroy', [$registrant->id]) }}" href="#">Delete</a>
                            </div>
                        </div>
                        <!-- /btn-group -->
                      </td>
