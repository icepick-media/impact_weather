    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">{{ $response->code }}</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">{{ $response->code }}</h3>
        <p class="text-muted mb-0">Edit response message details.</p>
      </div>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('code') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="code" class="form-control" placeholder="Code" name="code" value="{{ old('code', $response->code) }}">
                      ...
                      <div class="form-group {{ $errors->has('short_description') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="short_description" class="form-control" placeholder="Short Description" name="short_description" value="{{ old('short_description', $response->short_description) }}">
                      ...
                      <div class="form-group {{ $errors->has('content') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <textarea name="content" id="content" class="form-control" rows="7">{{ old('content', $response->content) }}</textarea>
