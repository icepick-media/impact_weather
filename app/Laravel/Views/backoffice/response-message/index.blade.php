    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Response Message</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">All Response Message</h3>
        <p class="text-muted mb-0">Record data of all response messages in your web application.</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $response->updated_at->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('backoffice.response_message.edit', [$response->id]) }}">Edit</a>
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.response_message.destroy', [$response->id]) }}" href="#">Delete</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
