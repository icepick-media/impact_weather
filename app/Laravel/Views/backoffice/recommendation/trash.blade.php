    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('backoffice.recommendation.index') }}">Recommendation</a></li>
          <li class="breadcrumb-item active">Trash</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Trashed Recommendation</h3>
        <p class="text-muted mb-0">Record data of deleted recommendations in your web application</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          {{-- <td>{{ $recommendation->short_description }}</td> --}}
                          <td>{{ $recommendation->content }}</td>
                          <td>{{ Carbon::parse($recommendation->deleted_at)->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    {{-- <a class="dropdown-item" href="{{ route('backoffice.recommendation.edit', [$recommendation->id]) }}">Edit</a> --}}
                                    <a class="dropdown-item btn-restore" data-url="{{ route('backoffice.recommendation.recover', [$recommendation->id]) }}" href="#">Restore</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
