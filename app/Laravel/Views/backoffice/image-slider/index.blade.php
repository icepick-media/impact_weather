  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">All Image Slider</h3>
        <p class="text-muted mb-0">Record data of all images in your image slider.</p>
      </div>
                          ...
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.image_slider.destroy', [$image->id]) }}" href="#">Delete</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
