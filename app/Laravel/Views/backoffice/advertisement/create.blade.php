  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Create Advertisement</h3>
        <p class="text-muted mb-0">Add a new image to your Advertisement.</p>
      </div>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('web_link') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-3">
                          <input type="text" id="web_link" class="form-control" placeholder="web_link" name="web_link" value="{{ old('web_link')}}">
