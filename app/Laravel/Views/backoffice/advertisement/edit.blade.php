    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('backoffice.advertisement.index') }}">Advertisement</a></li>
          <li class="breadcrumb-item active">Advertisement #{{ $image->id }}</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Advertisement #{{ $image->id }}</h3>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Advertisement Details</h4>
                ...
                <div class="card-block">
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('web_link') ? "has-danger" : NULL }} row">
                        <label class="col-md-2 label-control" for="web_link">Web link</label>
                        <div class="col-md-3">
                          <input type="text" id="web_link" class="form-control" placeholder="web_link" name="web_link" value="{{ old('web_link',$image->web_link)}}">
                          @if($errors->has('web_link')) <p class="text-xs-left"><small class="danger text-muted">{{ $errors->first('web_link') }}</small></p> @endif
                        </div>
                      </div>
                    ...
                    <div class="form-actions">
                      ...
                      <a href="{{ route('backoffice.advertisement.index') }}" class="btn btn-default">
