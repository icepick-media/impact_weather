    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">{{ $crop->name . " (" . $crop->code . ")" }}</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">{{ $crop->name . " (" . $crop->code . ")" }}</h3>
        <p class="text-muted mb-0">Edit details of this crop.</p>
      </div>
                ...
                <div class="card-block">
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                      ...
                      <a href="{{ route('backoffice.crop.index') }}" class="btn btn-default">
