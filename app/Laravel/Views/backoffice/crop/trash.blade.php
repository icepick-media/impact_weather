                  ...
                  <tbody>
                    @foreach($crops as $index => $crop)
                      <tr>
                        ...
                        <td>{{ $crop->code }}</td>
                        <td>{{ $crop->variety }}</td>
                        <td>{{ Carbon::parse($crop->deleted_at)->format("F d, Y") }}</td>
                        <td>
                          ...
                          <div class="btn-group dropup">
                              ...
                              <div class="dropdown-menu">
                                  {{-- <a class="dropdown-item" href="{{ route('backoffice.crop.edit', [$crop->id]) }}">Edit</a> --}}
                                  <a class="dropdown-item btn btn-warning btn-restore" data-url="{{ route('backoffice.crop.recover', [$crop->id]) }}" href="#">Restore</a>
                              </div>
                          </div>
                          <!-- /btn-group -->
                        </td>
