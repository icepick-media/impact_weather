    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Image Asset</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">All Image Asset</h3>
        <p class="text-muted mb-0">Record data of all images in your image asset.</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td title="{{ $image->directory . '/' . $image->filename }}">
                            <span>{{ Str::limit($image->directory . '/' . $image->filename, 45) }}</span>
                            <span><button title="Copy to clipboard" data-toggle="tooltip" class="btn btn-clipboard btn-sm" data-clipboard-text="{{ $image->directory . '/' . $image->filename }}" type="button"><i class="icon-copy"></i></button></span>
                          </td>
                          ...
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('backoffice.image_asset.edit', [$image->id]) }}">Edit</a>
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.image_asset.destroy', [$image->id]) }}" href="#">Delete</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
