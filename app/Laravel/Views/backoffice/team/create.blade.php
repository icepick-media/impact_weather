    ...
    <div class="content-header row">
      <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('backoffice.team.index') }}">Solution</a></li>
          <li class="breadcrumb-item active">Create</li>
        </ol>
      </div>
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Create Team</h3>
        <p class="text-muted mb-0">Add a new team member to your web application.</p>
      </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Team Details</h4>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('name') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="name" class="form-control" placeholder="Name" data-slug-input="#slug" name="name" value="{{ old('name') }}">
                      ...
                      <div class="form-group {{ $errors->has('facebook') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="facebook" class="form-control" placeholder="Facebook" name="facebook" value="{{ old('facebook') }}">
                      ...
                      <div class="form-group {{ $errors->has('twitter') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="twitter" class="form-control" placeholder="Twitter" name="twitter" value="{{ old('twitter') }}">
                      ...
                      <div class="form-group {{ $errors->has('linked_in') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="linked_in" class="form-control" placeholder="Linked In" name="linked_in" value="{{ old('linked_in') }}">
