  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">All Team</h3>
        <p class="text-muted mb-0">Record data of all team members in your web application.</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $member->updated_at->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.team.destroy', [$member->id]) }}" href="#">Delete</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
