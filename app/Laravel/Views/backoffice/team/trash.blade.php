  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Trashed Teams</h3>
        <p class="text-muted mb-0">Record data of deleted team members in your web application.</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ ++$index }}</td>
                          <td>{{ $member->title }}</td>
                          <td title="{{ $member->excerpt }}">{{ Str::limit($member->excerpt, 45) }}</td>
                          <td>{{ $member->sorting }}</td>
                          <td>{{ Carbon::parse($member->deleted_at)->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    {{-- <a class="dropdown-item" href="{{ route('backoffice.team.edit', [$member->id]) }}">Edit</a> --}}
                                    <a class="dropdown-item btn-restore" data-url="{{ route('backoffice.team.recover', [$member->id]) }}" href="#">Restore</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
