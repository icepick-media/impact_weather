  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">{{ $partner->name }}</h3>
        <p class="text-muted mb-0">Edit partner details.</p>
      </div>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('name') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="name" class="form-control" placeholder="Name" name="name" value="{{ old('name', $partner->name) }}">
                        ...
                        <div class="col-xl-6 col-md-6 col-xs-12">
                          <div class="card box-shadow-1">
                            <div class="text-xs-center">
                                <div class="card-block">
                                    <img src="{{ $partner->directory . "/resized/" . $partner->filename }}" class="" style="width: 100%;" alt="{{ $partner->name }}">
                                </div>
                            </div>
                        </div>
                        </div>
                      ...
                      <div class="form-group {{ $errors->has('url') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="url" class="form-control" placeholder="External Link" name="url" value="{{ old('url', $partner->url) }}">
                      ...
                      <div class="form-group {{ $errors->has('sorting') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-3">
                          <input type="number" id="sorting" class="form-control" placeholder="Sorting" name="sorting" value="{{ old('sorting', $partner->sorting) }}">
