  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">Trashed Activities</h3>
        <p class="text-muted mb-0">Record data of deleted activities in your mobile application.</p>
      </div>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $activity->name }}</td>
                          <td>{{ $activity->code }}</td>
                          <td>{{ Carbon::parse($activity->deleted_at)->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item btn-restore" data-url="{{ route('backoffice.activity.recover', [$activity->id]) }}" href="#">Restore</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
