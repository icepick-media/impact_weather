  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        <h3 class="content-header-title mb-0">"{{ $blog->title }}"</h3>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('user_id') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          {!! Form::select('user_id', $users, old('user_id', $blog->user_id), ['class' => "form-control"]) !!}
                      ...
                      <div class="form-group {{ $errors->has('title') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="title" class="form-control" placeholder="Title" data-slug-input="#slug" name="title" value="{{ old('title', $blog->title) }}">
                      ...
                      <div class="form-group {{ $errors->has('slug') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="slug" class="form-control" placeholder="Slug" name="slug" value="{{ old('slug', $blog->slug) }}">
                        ...
                        <div class="col-xl-6 col-md-6 col-xs-12">
                          <div class="card box-shadow-1">
                            <div class="text-xs-center">
                                <div class="card-block">
                                    <img src="{{ $blog->directory . "/resized/" . $blog->filename }}" class="" style="width: 100%;" alt="{{ $blog->title }}">
                                </div>
                            </div>
                        </div>
                        </div>
                      ...
                      <div class="form-group {{ $errors->has('excerpt') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <textarea name="excerpt" id="excerpt" class="form-control" placeholder="Excerpt" rows="7">{{ old('excerpt', $blog->excerpt) }}</textarea>
