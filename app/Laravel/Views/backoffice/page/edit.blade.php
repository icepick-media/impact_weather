  ...
  <div class="content-wrapper">
    <div class="content-header row">
      ...
      <div class="content-header-left col-md-6 col-xs-12">
        ...
        <p class="text-muted mb-0">Edit page details.</p>
      </div>
                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('title') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="title" class="form-control" placeholder="Title" data-slug-input="#code" name="title" value="{{ old('title', $page->title) }}">
                      ...
                      <div class="form-group {{ $errors->has('code') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="code" class="form-control" placeholder="Code" name="code" value="{{ old('code', $page->code) }}">
                      ...
                      <div class="form-group {{ $errors->has('description') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <textarea name="description" id="description" class="form-control" placeholder="Description" rows="7">{{ old('description', $page->description) }}</textarea>
