                  ...
                  <form class="form form-horizontal" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                      ...
                      <div class="form-group {{ $errors->has('title') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="title" class="form-control" placeholder="Title" data-slug-input="#slug" name="title" value="{{ old('title', $product->title) }}">
                      ...
                      <div class="form-group {{ $errors->has('slug') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="slug" class="form-control" placeholder="Slug" name="slug" value="{{ old('slug', $product->slug) }}">
                        ...
                        <div class="col-xl-6 col-md-6 col-xs-12">
                          <div class="card box-shadow-1">
                            <div class="text-xs-center">
                                <div class="card-block">
                                    <img src="{{ $product->directory . "/resized/" . $product->filename }}" class="" style="width: 100%;" alt="{{ $product->title }}">
                                </div>
                            </div>
                        </div>
                        </div>
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 label-control" for="">Current Icon</label>
                        <div class="col-xl-2 col-md-2 col-xs-12">
                          <div class="card box-shadow-1">
                            <div class="text-xs-center">
                                <div class="card-block">
                                    <img src="{{ $product->icon_directory . "/resized/" . $product->icon_filename }}" class="" style="width: 100%;" alt="{{ $product->title }}">
                                </div>
                            </div>
                        </div>
                        </div>
                      ...
                      <div class="form-group {{ $errors->has('icon_file') ? "has-danger" : NULL }} row">
                        <label class="col-md-2 label-control" for="icon_file">Change Icon</label>
                        <div class="col-md-9">
                      ...
                      <div class="form-group {{ $errors->has('content') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <textarea name="content" id="content" class="summernote">{!! old('content', $product->content) !!}</textarea>
                      ...
                      <div class="form-group {{ $errors->has('tags') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="tags" data-role="tagsinput" class="form-control" placeholder="Tags" name="tags" value="{{ old('tags', $product->tags) }}">
                      ...
                      <div class="form-group {{ $errors->has('sorting') ? "has-danger" : NULL }} row">
                        ...
                        <div class="col-md-3">
                          <input type="number" id="sorting" class="form-control" placeholder="Sorting" name="sorting" value="{{ old('sorting', $product->sorting) }}">
