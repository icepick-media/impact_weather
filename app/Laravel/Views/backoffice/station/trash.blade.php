...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Trashed Stations </h1>
    <ol class="breadcrumb">
      <li><a href="{{ route('backoffice.index') }}"><i class="fa fa-dashboard"></i> Home</a></li>
      <li><a href="{{ route('backoffice.station.index') }}"><i class="fa fa-dashboard"></i> Stations</a></li>
                        ...
                        <td>
                          ...
                          <div class="btn-group dropup">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item btn btn-warning btn-restore" data-url="{{ route('backoffice.station.recover', [$station->id]) }}" href="#">Restore</a>
                              </div>
                          </div>
                          <!-- /btn-group -->
                        </td>
