  ...
  <div class="content-wrapper">
    <div class="content-header1 row">
        <div class="content-header-left col-md-6 col-xs-12">
            <h3 class="content-header-title mb-0">Trashed Stations</h3>
            {{--<p class="text-muted mb-0">Record data of deleted stations in your mobile application.</p>--}}
              <div class="breadcrumb-wrapper col-xs-12 breadcrumb-top-dashboard">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{ route('backoffice.index') }}">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{ route('backoffice.station.index') }}">Stations</a></li>
                    ...
                    <table class="table table-striped table-bordered bootstrap-3 datatable">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{ $station->name }}</td>
                          <td>{{ $station->code }}</td>
                          <td>{{ Carbon::parse($station->deleted_at)->format("F d, Y") }}</td>
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    {{-- <a class="dropdown-item" href="{{ route('backoffice.station.edit', [$station->id]) }}">Edit</a> --}}
                                    <a class="dropdown-item btn-restore" data-url="{{ route('backoffice.station.recover', [$station->id]) }}" href="#">Restore</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
