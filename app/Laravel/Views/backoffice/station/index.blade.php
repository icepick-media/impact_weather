                          ...
                          <td>
                            ...
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('backoffice.station.edit', [$station->id]) }}">View Station Profile</a>
                                    <a target="_blank" class="dropdown-item" href="{{route('metos.weather',['json'])}}?station_id={{$station->code}}">Update Forecast</a>
                                    <a class="dropdown-item btn-delete" data-url="{{ route('backoffice.station.destroy', [$station->id]) }}" href="#">Remove Station</a>
                                </div>
                            </div>
                            <!-- /btn-group -->
                          </td>
